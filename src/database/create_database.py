...
def insert_test_data(cursor) -> None:
    ...
    ('Елена', 'Полуянова', 1, 'Терапевт', 75000.00),
    ('Виктория', 'Родионова', 1, 'Терапевт', 70000.00),
    ('Алла', 'Поплавкова', 2, 'Кардиолог', 80000.00),
    ('Алексей', 'Ляшенко', 3, 'Реаниматолог', 72000.00),
    ('Алла', 'Филимонова', 4, 'Хирург', 85000.00),
    ('Сорокина', 'Светлана', 5, 'Терапевт', 78000.00),
    ('Игорь', 'Дорохов', 6, 'Неврология', 82000.00),
    ('Юрий', 'Юрьев', 9, 'Терапевт', 76000.00),
    ('Анастасия', 'Деменева', 10, 'Офтальмолог', 83000.00),
    ('Анастасия', 'Борщ', 10, 'Терапевт', 77000.00);
    ...
    (4, '2025-04-05 14:00:00', 5, 4, 'Перелом', 'Гипсовая повязка', 5000.00, 'completed'),
    (5, '2025-05-12 16:30:00', 6, 5, 'Конъюнктивит', 'Глазные капли', 1500.00, 'completed'),
    (6, '2025-06-18 12:45:00', 7, 6, 'Отит', 'Антибиотики, капли', 2000.00, 'completed'),
    (7, '2025-07-25 10:15:00', 8, 7, 'Кариес', 'Чистка, пломба', 3500.00, 'completed'),
    (8, '2025-08-30 15:00:00', 9, 8, 'Травма лапы', 'Перевязка', 1800.00, 'completed'),
    ...
    (5, 'Вангард 7', 4, '2024-04-10', '2025-04-10', 4),
    (6, 'Фелоцел CVR', 5, '2024-05-17', '2025-05-17', 5),
    (7, 'Нобивак RL', 6, '2024-06-23', '2025-06-23', 6),
    (8, 'Раббивак-V', 7, '2024-07-30', '2025-07-30', 7),
    (9, 'Лейкоцел 2', 8, '2024-08-05', '2025-08-05', 8),
    (10, 'Дефенсор 3', 9, '2024-09-13', '2025-09-13', 9),
    (2, 'Мультифел-4', 10, '2024-10-20', '2025-10-20', 1);
    """)
