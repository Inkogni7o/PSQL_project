...
def insert_test_data(cursor) -> None:
    ...
    INSERT INTO Veterinarians (last_name, first_name, clinic_id, specialization, salary) VALUES
    ('Полуянова', 'Елена', 1, 'Терапевт', 75000.00),
    ('Родионова', 'Виктория', 1, 'Терапевт', 70000.00),
    ('Поплавкова', 'Алла', 2, 'Кардиолог', 80000.00),
    ('Ляшенко', 'Алексей', 3, 'Реаниматолог', 72000.00),
    ('Филимонова', 'Алла', 4, 'Хирург', 85000.00),
    ('Сорокина', 'Светлана', 5, 'Терапевт', 78000.00),
    ('Дорохов', 'Игорь', 6, 'Неврология', 82000.00),
    ('Юрьев', 'Юрий', 9, 'Терапевт', 76000.00),
    ('Деменева', 'Анастасия', 10, 'Офтальмолог', 83000.00),
    ('Борщ', 'Анастасия', 10, 'Терапевт', 77000.00);
    
    INSERT INTO Owners (last_name, first_name, phone, email, address, registration_date) VALUES
    ('Волков', 'Александр','+79161234567', 'volkov@mail.ru', 'г. Зеленоград, ул. Центральная, 10', '2020-01-15'),
    ('Зайцева', 'Екатерина', '+79162345678', 'zaytseva@mail.ru', 'г. Зеленоград, пр. Ленинградский, 25', '2019-05-20'),
    ('Медведев', 'Михаил', '+79163456789', 'medvedev@mail.ru', 'г. Зеленоград, ул. Солнечная, 5', '2021-03-10'),
    ('Лисицына', 'Ольга', '+79164567890', 'lisitsyna@mail.ru', 'г. Зеленоград, ул. Лесная, 12', '2018-07-05'),
    ('Соболев', 'Денис', '+79165678901', 'sobolev@mail.ru', 'г. Зеленоград, ул. Панфиловцев, 8', '2020-11-12'),
    ('Белова', 'Татьяна', '+79166789012', 'belova@mail.ru', 'г. Зеленоград, ул. Юности, 3', '2019-09-18'),
    ('Гусев', 'Артем', '+79167890123', 'gusev@mail.ru', 'г. Зеленоград, ул. Гоголя, 15', '2021-02-25'),
    ('Воробьева', 'Юлия', '+79168901234', 'vorobyeva@mail.ru', 'г. Зеленоград, ул. Пушкина, 6', '2018-04-30'),
    ('Орлов', 'Павел', '+79169012345', 'orlov@mail.ru', 'г. Зеленоград, ул. Фестивальная, 2', '2020-06-08'),
    ('Жукова', 'Алина','+79160123456', 'zhukova@mail.ru', 'г. Зеленоград, ул. Школьная, 9', '2019-12-03');
                   
    INSERT INTO Pets (name, owner_id, species, breed, birth_date, gender, registration_date) VALUES
    ('Барсик', 1, 'Кошка', 'Британская', '2018-05-10', 'M', '2020-01-20'),
    ('Шарик', 2, 'Собака', 'Лабрадор', '2017-03-15', 'M', '2019-05-25'),
    ('Мурка', 3, 'Кошка', 'Дворовая', '2019-07-22', 'F', '2021-03-15'),
    ('Рекс', 4, 'Собака', 'Овчарка', '2016-11-05', 'M', '2018-07-10'),
    ('Пушистик', 5, 'Кошка', 'Персидская', '2020-01-30', 'F', '2020-11-17'),
    ('Джек', 6, 'Собака', 'Джек-рассел', '2018-09-18', 'M', '2019-09-23'),
    ('Снежок', 7, 'Кролик', 'Карликовый', '2019-04-25', 'M', '2021-03-01'),
    ('Зефир', 8, 'Хомяк', 'Сирийский', '2020-02-14', 'F', '2018-05-05'),
    ...
    ('2025-01-10 10:00:00', 1, 1, 1,'Гастрит', 'Диета, лекарства', 2500.00, 'completed'),
    ('2025-02-15 11:30:00', 2, 3, 2, 'Аллергия', 'Антигистаминные препараты', 1800.00, 'completed'),
    ('2025-03-20 09:15:00', 3, 4, 3, 'Лишай', 'Противогрибковая мазь', 2200.00, 'completed'),
    ('2025-04-05 14:00:00', 4, 5, 4, 'Перелом', 'Гипсовая повязка', 5000.00, 'completed'),
    ('2025-05-12 16:30:00', 5, 6, 5, 'Конъюнктивит', 'Глазные капли', 1500.00, 'completed'),
    ('2025-06-18 12:45:00', 6, 7, 6, 'Отит', 'Антибиотики, капли', 2000.00, 'completed'),
    ('2025-07-25 10:15:00', 7, 8, 7, 'Кариес', 'Чистка, пломба', 3500.00, 'completed'),
    ('2025-08-30 15:00:00', 8, 9, 8, 'Травма лапы', 'Перевязка', 1800.00, 'completed'),
    ('2025-09-08 11:30:00', 9, 10, 9, 'Диабет', 'Инсулинотерапия', 4000.00, 'completed'),
    ('2025-10-15 13:45:00', 10, 2, 1, 'Чумка', 'Интенсивная терапия', 6000.00, 'completed');
                   
    INSERT INTO Vaccinations (vaccine_name, pet_id, vet_id, vaccination_date, next_vaccination_date, clinic_id) VALUES
    ('Nobivac Tricat', 1, 1, '2024-01-15', '2025-01-15', 1),
    ('Эурикан DHPPI2-LR', 3, 2, '2024-02-20', '2025-02-20', 2),
    ('Purevax RCPCh', 4, 3, '2024-03-25', '2025-03-25', 3),
    ('Вангард 7', 5, 4, '2024-04-10', '2025-04-10', 4),
    ('Фелоцел CVR', 6, 5, '2024-05-17', '2025-05-17', 5),
    ('Нобивак RL', 7, 6, '2024-06-23', '2025-06-23', 6),
    ('Раббивак-V', 8, 7, '2024-07-30', '2025-07-30', 7),
    ('Лейкоцел 2', 9, 8, '2024-08-05', '2025-08-05', 8),
    ('Дефенсор 3', 10, 9, '2024-09-13', '2025-09-13', 9),
    ('Мультифел-4', 2, 10, '2024-10-20', '2025-10-20', 1);
    """)
