...
def insert_test_data(cursor) -> None:
    ...
    (1, 1, 'Nobivac Tricat', '2024-01-15', '2025-01-15', 'BATCH123', 1),
    (2, 3, 'Эурикан DHPPI2-LR', '2024-02-20', '2025-02-20', 'BATCH456', 2),
    (3, 4, 'Purevax RCPCh', '2024-03-25', '2025-03-25', 'BATCH789', 3),
    (4, 5, 'Вангард 7', '2024-04-10', '2025-04-10', 'BATCH012', 4),
    (5, 6, 'Фелоцел CVR', '2024-05-17', '2025-05-17', 'BATCH345', 5),
    (6, 7, 'Нобивак RL', '2024-06-23', '2025-06-23', 'BATCH678', 6),
    (7, 8, 'Раббивак-V', '2024-07-30', '2025-07-30', 'BATCH901', 7),
    (8, 9, 'Лейкоцел 2', '2024-08-05', '2025-08-05', 'BATCH234', 8),
    (9, 10, 'Дефенсор 3', '2024-09-13', '2025-09-13', 'BATCH567', 9),
    (10, 2, 'Мультифел-4', '2024-10-20', '2025-10-20', 'BATCH890', 1);
    """)
