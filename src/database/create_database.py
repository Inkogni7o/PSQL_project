...
def insert_test_data(cursor):
    ...
    (1, 1, 1, '2021-01-10 10:00:00', 'Гастрит', 'Диета, лекарства', 2500.00, 'completed'),
    (2, 3, 2, '2021-02-15 11:30:00', 'Аллергия', 'Антигистаминные препараты', 1800.00, 'completed'),
    (3, 4, 3, '2021-03-20 09:15:00', 'Лишай', 'Противогрибковая мазь', 2200.00, 'completed'),
    (4, 5, 4, '2021-04-05 14:00:00', 'Перелом', 'Гипсовая повязка', 5000.00, 'completed'),
    (5, 6, 5, '2021-05-12 16:30:00', 'Конъюнктивит', 'Глазные капли', 1500.00, 'completed'),
    (6, 7, 6, '2021-06-18 12:45:00', 'Отит', 'Антибиотики, капли', 2000.00, 'completed'),
    (7, 8, 7, '2021-07-25 10:15:00', 'Кариес', 'Чистка, пломба', 3500.00, 'completed'),
    (8, 9, 8, '2021-08-30 15:00:00', 'Травма лапы', 'Перевязка', 1800.00, 'completed'),
    (9, 10, 9, '2021-09-08 11:30:00', 'Диабет', 'Инсулинотерапия', 4000.00, 'completed'),
    (10, 2, 1, '2021-10-15 13:45:00', 'Чумка', 'Интенсивная терапия', 6000.00, 'completed');
                   
    INSERT INTO Vaccinations (pet_id, vet_id, vaccine_name, vaccination_date, next_vaccination_date, batch_number, clinic_id) VALUES
    (1, 1, 'Nobivac Tricat', '2021-01-15', '2022-01-15', 'BATCH123', 1),
    (2, 3, 'Эурикан DHPPI2-LR', '2021-02-20', '2022-02-20', 'BATCH456', 2),
    (3, 4, 'Purevax RCPCh', '2021-03-25', '2022-03-25', 'BATCH789', 3),
    (4, 5, 'Вангард 7', '2021-04-10', '2022-04-10', 'BATCH012', 4),
    (5, 6, 'Фелоцел CVR', '2021-05-17', '2022-05-17', 'BATCH345', 5),
    (6, 7, 'Нобивак RL', '2021-06-23', '2022-06-23', 'BATCH678', 6),
    (7, 8, 'Раббивак-V', '2021-07-30', '2022-07-30', 'BATCH901', 7),
